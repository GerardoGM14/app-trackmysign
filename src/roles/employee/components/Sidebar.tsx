...
const NAV_SECTIONS: NavSection[] = [
    {
        ...
        items: [
            ...
            { icon: <BsInbox size={15} />, label: 'Mis pendientes', path: '/inbox', badge: 3 },
            { icon: <BsCalculator size={15} />, label: 'Cotizaciones', path: '/quotes' },
            { icon: <BsKanban size={15} />, label: 'Órdenes', path: '/orders' },
            { icon: <BsFileEarmarkText size={15} />, label: 'Mis documentos', path: '/my-documents' },
        ],
    },
    {
        label: 'Personal',
        items: [
            { icon: <BsBarChart size={15} />, label: 'Mi actividad', path: '/activity' },
                ...
                {sidebarOpen ? (
                    <div className="flex items-center gap-2.5 px-2 py-2">
                        ...
                        <div className="min-w-0 flex-1">
                            <p className="text-[12px] font-medium text-white truncate capitalize">{userName}</p>
                            <p className="text-[10px] text-white/50">Empleado</p>
                        </div>
                    </div>
                ) : (
