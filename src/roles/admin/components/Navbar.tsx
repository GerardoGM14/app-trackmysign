...
const SECTIONS: SectionDef[] = [
    ...
    { label: 'Documentos', path: '/documents', icon: <BsFileEarmarkText size={13} />, parent: 'Operación' },
    { label: 'Empleados', path: '/employees', icon: <BsPeople size={13} />, parent: 'Equipo' },
    { label: 'Reportes', path: '/reports', icon: <BsBarChart size={13} />, parent: 'Equipo' },
    { label: 'Configuración', path: '/settings', icon: <BsGear size={13} />, parent: 'Empresa' },
];
...
const INITIAL_NOTIFICATIONS: NotificationItem[] = [
    { id: '1', title: 'Nuevo documento firmado', body: 'Ana Pérez firmó el contrato 2026-042.', time: 'hace 8 min', unread: true },
    { id: '2', title: 'Empleado invitado', body: 'Carlos López aceptó la invitación al equipo.', time: 'hace 1 h', unread: true },
    { id: '3', title: 'Plan próximo a renovar', body: 'Tu plan se renueva el 1 de junio.', time: 'ayer', unread: false },
];
...
export default function Navbar({ sidebarOpen, setSidebarOpen }: NavbarProps) {
    ...
    const avatarUrl = `https://api.dicebear.com/7.x/notionists/svg?seed=Admin-${user?.email ?? 'default'}`;
            ...
            <header className="h-14 bg-white px-3 sm:px-4 flex items-center justify-between border-b border-slate-200 shrink-0 relative z-20 gap-3">
                ...
                <div className="hidden md:flex max-w-md flex-1 mx-2">
                    ...
                    >
                        ...
                        <span className="flex-1 text-left truncate">Buscar documentos, empleados...</span>
            ...
            >
                <div className="flex items-center gap-2.5 px-4 h-12 border-b border-slate-200">
                    ...
                    <input
                        ...
                        placeholder="Buscar páginas, documentos, empleados..."
